...
// Use system fonts — react-pdf has built-in support for standard fonts
// No need to register; just reference them directly in StyleSheet

// react-pdf uses pt units (1pt = 1/72 inch)
// A4 page: 595pt × 842pt with 54pt margins ≈ 487pt wide content
const styles = StyleSheet.create({
  ...
  expRole:    { fontSize: 9.5, fontWeight: 'bold', color: '#111' },
...
// ─────────────────────────────────────────────────────────
// Sub-components — all use react-pdf primitives only
// ─────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────
// Main component — takes the final merged ResumeJSON
// ─────────────────────────────────────────────────────────
