    ...
    <div className="bg-white border-b border-gray-200 flex-shrink-0">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {value.trim() && (
            <span className="text-xs text-gray-400">{wordCount} words pasted</span>
          )}
          {!value.trim() && (
            <span className="text-xs text-amber-500">← paste JD here first</span>
          )}
        </div>
      ...
      {open && (
        <div className="px-4 pb-4">
          <textarea
            ...
            className="w-full h-40 text-sm text-gray-700 border border-gray-200 rounded-lg p-3 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-300"
          />
